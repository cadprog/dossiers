...
<!--main style-->
<link rel="stylesheet" type="text/css" media="screen" href="Views/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" media="screen" href="Views/css/main.css">
<link rel="stylesheet" type="text/css" media="screen" href="Views/css/skins/default.css" data-name="skins">
          ...
          <div class="slide"> 
            ...
            <div class="container hedaer-inner">
              <div class="bannerText">
                ...
                <p><a href="Views/connexion.php" class="smooth">Se Connecter <i class="fa fa-angle-right"></i></a></p>
              </div>
            </div>
            <!--Header text1 end--> 
...
<!--modernizr js--> 
<script type="text/javascript" src="Views/js/modernizr.custom.26633.js"></script> 
<!--jquary min js--> 
<script type="text/javascript" src="Views/js/jquery-1.11.2.min.js"></script> 
<script src="Views/js/bootstrap.min.js"></script> 

<!--for placeholder jquery--> 
<script type="text/javascript" src="Views/js/jquery.placeholder.js"></script> 

<!--for header jquery--> 
<script type="text/javascript" src="Views/js/stickUp.js"></script> 
<script src="Views/js/jquery.superslides.js" type="text/javascript" charset="utf-8"></script> 
...
<script src="Views/js/jquery.isotope.js" type="text/javascript"></script>
<link type="text/css" rel="stylesheet" property="stylesheet" id="theme" href="Views/css/jquery-ui-1.8.16.custom.css">
<link type="text/css" rel="stylesheet" property="stylesheet" href="Views/css/lightbox.min.css">
<script type="text/javascript" src="Views/js/jquery.ui.widget.min.js"></script> 
<script type="text/javascript" src="Views/js/jquery.ui.rlightbox.js"></script> 

<!--for video lightbox -->
<link rel="stylesheet" property="stylesheet" href="Views/css/prettyPhoto.css" type="text/css" media="screen" title="prettyPhoto main stylesheet" charset="utf-8" />
<script src="Views/js/jquery.prettyPhoto.js" type="text/javascript"></script>

<!--contact form js--> 
<script type="text/javascript" src="Views/js/jquery.contact.js"></script> 
<!--Newsletter js--> 
<script type="text/javascript" src="Views/js/jquery.subscribe.js"></script> 
...
<!--about jquery--> 
<script src="Views/js/jquery.classyloader.min.js"></script> 
<script defer src="Views/js/jquery.flexslider.js"></script> 
<script src="Views/js/jquery.easing.js"></script> 
<script src="Views/js/jquery.mousewheel.js"></script> 
<script defer src="Views/js/slideroption.js"></script> 
