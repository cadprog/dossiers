...
<head>
    ...
    <link href="style/assets/css/lib/vector-map/jqvmap.min.css" rel="stylesheet">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><h1 style="color: #E5C626">SenshOol</h1></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        ...
                        <a href="ajoutpubs.php"><i class="menu-icon fa fa-plus-circle"></i>Ajouter Pub</a>
                        <a href="connexion.php"><i class="menu-icon fa fa-sign-in"></i>Connexion</a>
                        <a href="#"><i class="menu-icon fa fa-sign-out"></i>Déconnexion</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="user.png" alt="User Avatar">
                        </a>
